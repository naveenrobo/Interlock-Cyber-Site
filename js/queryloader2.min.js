...
! function e(t, i, s) {
    function n(o, a) {
        if (!i[o]) {
            if (!t[o]) { var l = "function" == typeof require && require; if (!a && l) return l(o, !0); if (r) return r(o, !0); throw new Error("Cannot find module '" + o + "'") }
            var u = i[o] = { exports: {} };
            t[o][0].call(u.exports, function(e) { var i = t[o][1][e]; return n(i ? i : e) }, u, u.exports, e, t, i, s)
        }
        return i[o].exports
    }
    ...
    1: [function(e, t) {
        ...
        i.prototype.create = function() {
            ...
            "use strict";
            s(this.element, function(t, i) { e(t, i) })
        }, t.exports = i
    }, { "./ImageLoaded.js": 2 }],
    2: [function(e, t) {
        function i(e, t) {
            ...
            function i(e, t, i, s) { e.addEventListener ? e[i ? "addEventListener" : "removeEventListener"](t, s) : e[i ? "attachEvent" : "detachEvent"]("on" + t, s) }

            function n() { i(e, "load", !1, n), i(e, "error", !1, n), t(null, !1) }
            var r;
    ...
    3: [function(e, t) {
        ...
        }, i.prototype.hasGradient = function(e) { "use strict"; return e && "undefined" != typeof e.indexOf ? -1 !== e.indexOf("gradient(") : !1 }, i.prototype.stripUrl = function(e) { "use strict"; return e = e.replace(/url\(\"/g, ""), e = e.replace(/url\(/g, ""), e = e.replace(/\"\)/g, ""), e = e.replace(/\)/g, "") }, i.prototype.validUrl = function(e) { "use strict"; return e.length > 0 && !e.match(/^(data:)/i) ? !0 : !1 }, i.prototype.urlIsNew = function(e) { "use strict"; return -1 === this.sources.indexOf(e) }, i.prototype.isIE = function() { "use strict"; return navigator.userAgent.match(/msie/i) }, i.prototype.isOpera = function() { "use strict"; return navigator.userAgent.match(/Opera/i) }, t.exports = i
    }, { "./Image.js": 1 }],
    4: [function(e, t) {
        function i() {
            "use strict";
    ...
    6: [function(e, t) {
        ...
        }, i.prototype.calculatePosition = function() { "use strict"; var e = "absolute"; return "body" === this.parentElement.tagName.toLowerCase() ? e = "fixed" : ("fixed" !== this.parentElement.style.position || "absolute" !== this.parentElement.style.position) && (this.parentElement.style.position = "relative"), e }, i.prototype.updateProgress = function(e, t) {
            "use strict";
        ...
        }, i.prototype.canRemove = function(e) { "use strict"; return e.parentNode && "undefined" != typeof e.parentNode.removeChild }, t.exports = i
    ...
    7: [function() {
        Function.prototype.bind || (Function.prototype.bind = function(e) {
            ...
            var t = Array.prototype.slice.call(arguments, 1),
                i = this,
                s = function() {},
                n = function() { return i.apply(this instanceof s && e ? this : e, t.concat(Array.prototype.slice.call(arguments))) };
    ...
    8: [function(e, t) {
        function i(e, t) {
            "use strict";
            this.element = e, this.options = t, this.done = !1, this.maxTimeout = null, this.defaultOptions = { onComplete: function() {}, onProgress: function() {}, backgroundColor: "#000", barColor: "#fff", overlayId: "qLoverlay", percentageId: "qLpercentage", barHeight: 1, percentage: !1, deepSearch: !0, minimumTime: 300, maxTime: 1e4, fadeOutTime: 1e3 }, this.overlay = null, this.preloader = null, null !== e && this.init()
        }
        ...
        i.prototype.init = function() {
        ...
        }, i.prototype.extend = function(e, t) { "use strict"; "undefined" == typeof e && (e = {}); for (var i in t) t.hasOwnProperty(i) && (e[i] = t[i]); return e }, i.prototype.startMaxTimeout = function() {
            "use strict";
            ...
            "use strict";
            this.preloader = new s(this), this.preloader.deepSearch = this.options.deepSearch, window.setTimeout(function() { this.preloader.findAndPreload(this.element) }.bind(this), 100)
        }, i.prototype.updateProgress = function(e, t) {
            "use strict";
            var i = e / t * 100;
    ...
    9: [function(e, t) {
        ...
        (window.jQuery || window.Zepto) && ! function(e) {
            "use strict";
            e.fn.queryLoader2 = function(e) { return this.each(function() { new i(this, e) }) }
        }(window.jQuery || window.Zepto), "undefined" != typeof t && (t.exports = i), "function" == typeof define && define.amd && define([], function() { "use strict"; return i }), window.QueryLoader2 = i, i.createTempOverlay()
